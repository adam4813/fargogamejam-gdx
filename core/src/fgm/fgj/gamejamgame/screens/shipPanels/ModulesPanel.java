...
public class ModulesPanel {
	...
	public void displayModules(GameJamGame game, Ship ship) {
		...
		int engineLevel = ship.getEngineModuleLevel() + 1;
		...
		int lifeSupportLevel = ship.getLifeSupportSystemsModuleLevel() + 1;
		...
		int weaponLevel = ship.getWeaponModuleLevel() + 1;
		...
		int cargoBaryLevel = ship.getCargoBayModuleLevel() + 1;
