...
public class EndGameScreen extends ScreenAdapter {
	...
	public EndGameScreen(GameJamGame game, Music music, Texture backgroundTexture, boolean loopBackgroundAnimation) {
		this.game = game;
		stage = new Stage();
		Table root = new Table();
		root.setFillParent(true);
		backgroundStars = new StarField(40);
		Animation loseAnimation = AnimatedSprite.buildAnimation(backgroundTexture, 1280, 720, 10, .2f);
		AnimatedImage image = new AnimatedImage(loseAnimation, loopBackgroundAnimation);
